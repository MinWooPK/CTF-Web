...
import {
  CollaborationsMain,
  TitleSection,
  TitleCollaborationsUs,
  SubTitleCollaborationsUs,
  ProyectSection,
} from "./style";
...
const CollaborationsPage = () => {
  ...
  return (
    <>
      ...
      >
        <TitleCollaborationsUs>Nuestros Proyectos</TitleCollaborationsUs>
        <SubTitleCollaborationsUs>
          Nos especializamos en Fintech, Banca, Proptech, ERPs & CRMs, y también
          hacemos software a medida.
        </SubTitleCollaborationsUs>
      </TitleSection>
      <CollaborationsMain>
        <ProyectSection>
